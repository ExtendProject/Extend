...
const App = () => {
  ...
  return (
    <ScrollView
      ...
      <Text style={styles.title}>Site Preparation Phase</Text>
      <Image
      ...
      <View style={styles.listContainer}>
        <View>
          {['Excavators', 'Loaders'].map((item, index) => (
      ...
      <View style={styles.bottom}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('Foundation Phase')}>
