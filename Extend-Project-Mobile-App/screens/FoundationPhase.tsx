...
const FoundationPhase = () => {
  ...
  return (
    <ScrollView
      ...
      <Text style={styles.title}>Foundation Phase</Text>
      <Image
      ...
      <View style={styles.bottom}>
        <View style={styles.estimatedCostContainer}>
          ...
          <Text style={styles.costValue}>GHC 15,000.00</Text>
        </View>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('Structural Phase')}>
