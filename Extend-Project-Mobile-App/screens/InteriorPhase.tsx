...
const InteriorPhase = () => {
  ...
  return (
    <ScrollView
      ...
      <Text style={styles.title}>Interior Phase</Text>
      <Image
        source={require('../assets/images/interiorPhase.png')}
        style={styles.image}
      />
      {/* blueprint.png */}
      ...
      <View style={styles.bottom}>
        <View style={styles.estimatedCostContainer}>
          ...
          <Text style={styles.costValue}>$10,000.00</Text>
        </View>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity
            ...
            <Text style={styles.buttonText1}>Finished</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ScrollView>
