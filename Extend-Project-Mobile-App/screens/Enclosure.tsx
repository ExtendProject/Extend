...
const EnclosurePhase = () => {
  const navigation: any = useNavigation();
  return (
    <ScrollView
      style={styles.container}
      contentContainerStyle={styles.container1}>
      <Text style={styles.title}>Enclosure Phase</Text>
      <Image
        source={require('../assets/images/enclosure.png')}
        style={styles.image}
      />
      {/* blueprint.png */}
      ...
      <View style={styles.bottom}>
        <View style={styles.estimatedCostContainer}>
          ...
          <Text style={styles.costValue}>GHC 10,000.00</Text>
        </View>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('Interior Phase')}>
